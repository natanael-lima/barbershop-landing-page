...
export default function About() {
  return (
    <div id='about' className="py-16 flex flex-col items-center w-full">  
      <div className="container m-auto px-6 text-stone-600 md:px-12 xl:px-6">
        <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
          <div className="md:5/12 lg:w-5/12">
            <img src="https://i.postimg.cc/59QZny5x/bannerbarber.png" alt="Barbershop image" loading="lazy" width="" height=""/>
          </div>
